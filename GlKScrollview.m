...
-(void)loadDATA{
    self.data = [NSMutableDictionary dictionaryWithObjectsAndKeys:@"1.jpg",@"2.jpg",@"3.jpg",@"4.jpg",@"5.jpg",@"11",@"22",@"33",@"44",@"55", nil];
    self.imageCount = [self.data allKeys].count;
}
-(void)addUI{
...
-(void)addLabel{
    ...
    self.title.textColor=[UIColor colorWithRed:0 green:150/255.0 blue:1 alpha:1];
